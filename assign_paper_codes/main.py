...
for ind1 in range(0,Num_samples):
    ...
    for ind2 in range(0,np.size(x_axis_cand,axis=0)):
        ...
        elif np.any(x_axis_cand=="err_min_cand"):

            sys_param["err_min"] = x_axis_cand[ind2]
        
        elif np.any(x_axis_cand == "No_W_unc_dB_cand"):
        ...
        Solutions_P_D_temp[0,ind2]=solutions_algorithm_1
        ...
        Solutions_P_D_temp[1,ind2] = solutions_algorithm_2
        ...
        Solutions_P_D_temp[2,ind2] = solutions_algorithm_3
        ...
        Solutions_P_D_temp[3,ind2] = solutions_algorithm_4
        ...
        Solutions_P_D_temp[4,ind2] = solutions_algorithm_5
